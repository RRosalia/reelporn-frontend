...
function MainLayout({ children, hideUI }: MainLayoutProps) {
    ...
    // Check if current page is a payment status page or checkout page (simplified UI)
    ...
    const isCheckoutPage = pathname?.includes('/checkout') ||
                          pathname?.includes('/afrekenen') ||
                          pathname?.includes('/kasse') ||
    ...
    // Simplified layout for payment and checkout pages
    if (isPaymentPage || isCheckoutPage) {
        return (
            <>
                ...
                {/* Minimal Footer - No links for checkout pages */}
                <footer className="bg-gray-900 dark:bg-gray-950 border-t border-gray-800 py-4 relative z-10">
                    <div className="container mx-auto px-4">
