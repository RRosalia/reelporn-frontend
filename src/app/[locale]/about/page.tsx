          ...
          <div className="flex flex-wrap">
            <div className="w-full md:w-4/12">
              <div className="contact-card">
                ...
                <a href={`mailto:${t("contact.general.email")}`}>
                  {t("contact.general.email")}
                </a>
              </div>
            </div>
            <div className="w-full md:w-4/12">
              <div className="contact-card">
                ...
                <a href={`mailto:${t("contact.support.email")}`}>
            ...
            <div className="w-full md:w-4/12">
              <div className="contact-card">
                ...
                <a href={`mailto:${t("contact.business.email")}`}>
